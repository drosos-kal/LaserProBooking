    ...
    public class CalendarViewModel : MasterPageViewModel
    {
        ...
        public List<string> ResetTherapyTypes()
        {
            return new List<string>
                {
                    "Μουστάκι", "Πρόσωπο", "Μασχάλες", "Στήθος", "Χέρια", "Κοιλιά", "Πλάτη", "Ώμοι", "Μπικίνι", "Γλουτοί", "Κνήμες", "Μηροί", "Πόδια", "Αυτιά", "Αυχένας", "Μούσι", "Full Body", "Μέση", "Θηλές", "Γραμμή Κοιλιάς", "Έσω γλουτοί", "Πηγούνι"
                }.OrderBy(x => x).ToList();
        }
